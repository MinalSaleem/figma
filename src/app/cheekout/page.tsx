...
import cheekout from "@/../../public/cheekout/main.png"
import Header from "../components/Header"

export default function CheekoutPage() {
  return (
    <div>
      <Header title="Cheekout Page" route="Checkout" />
    
    <div className="mt-[90px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
